...
class PhononMutable : Phonon {
  ...
  override fun getBar(band: Int): Float {
  ...
  override val minVolText: String
    get() = "$mMinVol%"
  ...
  override val periodText: String
    get() {
  ...
  private val periodSeconds: Float
    private get() =// This is a somewhat human-friendly mapping from
  ...
  override fun makeMutableCopy(): PhononMutable {
    check(!isDirty)
    val c = PhononMutable()
  ...
  override fun writeIntent(intent: Intent?) {
  ...
  override fun fastEquals(other: Phonon?): Boolean {
    val o = other as PhononMutable?
    check(!(isDirty || o!!.isDirty))
    return if (this === o) {
      true
    } else mHash == o!!.mHash && mMinVol == o.mMinVol && mPeriod == o.mPeriod && mBars.contentEquals(o.mBars)
  }
